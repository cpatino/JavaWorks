...
public class JDClinicHistorySummary extends JDialog {
	...
	private JPanel createSummaryFrame(Pet pet, ClinicHistorySummaryController controller) {
		...
		jpnCentral.add(createTablePanelWithTitle("Resumén de condición de la mascota", jpPetWeight.getTabPanel()));
		//Creates resume for pet food section
		JPTablePetFood jpPetFood = new JPTablePetFood(null);
		jpnCentral.add(createTablePanelWithTitle("Resumén de comidas de la mascota", jpPetFood.getTabPanel()));
		//Creates resume for pet vaccine section
		JPTablePetVaccine jpPetVaccine = new JPTablePetVaccine(null);
		jpnCentral.add(createTablePanelWithTitle("Resumén de vacunas de la mascota", jpPetVaccine.getTabPanel()));
		//Create resume for pet drenching section
		JPTablePetDrenching jpPetDrenching = new JPTablePetDrenching(null);
		jpnCentral.add(createTablePanelWithTitle("Resumén de desparasitaciones de la mascota", jpPetDrenching.getTabPanel()));
		return jpnCentral;
	}
